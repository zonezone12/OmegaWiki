...
Usage:
    python tools/fetch_s2.py search "low rank adaptation"
    python tools/fetch_s2.py paper 2106.09685
    python tools/fetch_s2.py citations 2106.09685
    python tools/fetch_s2.py references 2106.09685
"""
