...
### Tools（via Bash）
- `python tools/fetch_arxiv.py --hours <N> -o <path>` — 拉取 arXiv RSS
- `python tools/fetch_deepxiv.py trending --days 7 --limit 20` — 获取热门论文
- `python tools/fetch_deepxiv.py brief <arxiv_id>` — 获取论文 TLDR 和关键词
