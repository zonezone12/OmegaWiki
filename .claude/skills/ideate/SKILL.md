...
### Tools（via Bash）
- `python tools/research_wiki.py maturity wiki/ --json` — check wiki maturity + Growth Report
...
- `python tools/fetch_s2.py search "<query>" --limit 20` — Semantic Scholar search
- `python tools/fetch_deepxiv.py search "<query>" --mode hybrid --limit 20` — DeepXiv semantic search
- `python tools/fetch_deepxiv.py brief <arxiv_id>` — fetch paper TLDR
- `python tools/fetch_deepxiv.py trending --days 14` — trending paper trends
