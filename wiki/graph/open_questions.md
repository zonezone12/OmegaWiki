...
- [concept/graph-field-network] Energy distillation: can a teacher energy-based model train a GFN student that also predicts energies?
- [concept/graph-field-network] Equivariance: current GFN builds equivariance via MolCT; fully equivariant GFN architectures unexplored
- [concept/graph-field-network] Generalization to biomolecular systems with diverse chemistry
- [concept/graph-field-network] Uncertainty quantification for active learning with force-only models
